...
public class BrowserSession {
    ...
    public void startBrowserSession(String testName){
     //Launching the browser according to the environment
        if (ApplicationSettings.BROWSER_NAME.equalsIgnoreCase("chrome")) {
        ...
        else if(ApplicationSettings.BROWSER_NAME.equalsIgnoreCase("firefox")) {
        ...
        driver.get(ApplicationSettings.URL_PATH);
    }
}
